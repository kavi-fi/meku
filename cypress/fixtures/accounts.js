...
module.exports = [
  ...
  {name: "DEMO tilaaja 4", roles: ['Subscriber', 'Classifier'], emailAddresses: ['demo.4@email.org'], users: users, yTunnus: 'DEMO4', address: {street: '', zip: '00000', city: 'Helsinki'}, apiToken: 'clientToken2'}
]
