...
describe('Classification', () => {
  ...
  it('registers a reclassification as KAVI', () => {
    ...
    cy.getDataCy('classification-page classification-email registration-emails').should('have.value', 'kavi@fake-meku.fi,demo.1@email.org,leo.pekkala@kavi.fi,leena.karjalainen@kavi.fi,tuula.roos@kavi.fi')
