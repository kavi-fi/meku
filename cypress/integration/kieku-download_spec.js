  ...
  it('returns proper csv file', () => {
    ...
    cy.getCookie('_csrf_token').then((csrf) => {
      cy.request({
        ...
        cy.expect(rows[0]).to.equal(`T,Tilauslaji,Myyntiorg,Jakelutie,Sektori,Myyntitsto,Viitelasku,Asiakasnro,Nimi,Nimi2,Lähiosoite,PostiNo,Toimipaikka,Maakoodi,Kielikoodi,Henkilötunnus,Y-tunnus,ALV-tunnus,OVT-tunnus,Välittäjätunnus,Laskutusasiakasnro,Laskutusasiakas nimi,Maksaja-asiakasnro,Maksaja-asiakas nimi,Toimitusasiakasnro,Toimitusasiakas nimi,Palvelun luontipvm,Hinnoittelupvm,Laskun pvm,Maksuehto,Laskuttaja,Asiaviite,Tilausnumero,Sopimuspvm,Sopimusnumero,Tiliöintiviite,Työmaa-avain,Poikk. veron määrämaa,Turvaluokitus,"Otsikkoteksti: Otsikkomuistio 1 (tekstilaji 0002) tulostuu ennen rivejä. Huom. Kirjoita teksti katkeamattomasti, ei rivivaihtoja eikä alt+enter painikkeita","Otsikkoteksti: Maksuperusteteksti (tekstilaji Z000) tulostuu laskun loppuun. Huom. Kirjoita teksti katkeamattomasti, ei rivivaihtoja eikä alt+enter painikkeita",Nimike,Määrä,Määräyksikkö,Yksikköhinta,Brutto/Netto,Rivityyppi,Tulosyksikkö,Nimikkeen nimitysteksti (laskutusaihe),"Riviteksti: Rivimuistio (tekstilaji 0002), tulostuu laskulle rivin jälkeen",PRR-osa,TaKP-tili,Suorite,Toiminto,Alue /  kunta,Seurantakohde 1,Seurantakohde 2,Laskuliitteet`)
        cy.expect(rows[1]).to.equal(`1,Z001,6040,02,01,,,,DEMO tilaaja 1,,,00000,Helsinki,,,,DEMO1,,,,,,,,,,,,,,,,,,,,,,,KOONTILASKUTUS 1.1.2000 - 1.1.3000,"2 kuvaohjelmaa luokiteltu, yhteensä 336 EUR.",4691,84,min,2,N,,,,4 ${today} Ghostbusters XVI,,,,,,,,`)
        cy.expect(rows[2]).to.equal(`0,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,4691,84,min,2,N,,,,5 ${today} Terminator XII,,,,,,,,`)
        cy.expect(rows[3]).to.equal(`1,Z001,6040,02,01,,,,DEMO tilaaja 1,,,00000,Helsinki,,,,DEMO1,,,,,,,,,,,,,,,,,,,,,,,KOONTILASKUTUS 1.1.2000 - 1.1.3000,"2 kuvaohjelmaa rekisteröity, yhteensä 26 EUR.",1852,1,kpl,13,N,,,,4 ${today} Ghostbusters XVI,,,,,,,,`)
