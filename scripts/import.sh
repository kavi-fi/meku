...
node scripts/sql-import.js metadata classifications markTrainingProgramsDeleted \
  markUnclassifiedProgramsDeleted linkTvSeries linkCustomersIds metadataIndex nameIndex
