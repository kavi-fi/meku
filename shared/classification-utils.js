  ...
  exports.registrationEmail = function(program, classification, user, hostName) {
    ...
    function generateData(lang) {
      ...
      function appendixLink() {
        ...
        const linkOther = {url: "https://kavi.fi/wp-content/uploads/2023/07/Oikaisuvaatimusohje__kuvaohjelmaluokittelijan-luokittelupaatos.pdf", name: t('Oikaisuvaatimusohje')}
