(function (exports) {
  ...
  exports.classificationCategoriesSV = {violence: 'våld', fear: 'ångest', sex: 'sexuellt innehåll', drugs: 'rusmedel', vet: 'vet'}
  ...
  exports.util.userRoleName = function(role) {
    const userRole = exports.userRoles[role]
    return userRole ? userRole.name : undefined
  }

  exports.util.isClassifier = function(role) {
  ...
  exports.providingTypeName = function(type) {
    return exports.providingType[type] || 'Tuntematon'
  }

  exports.invoiceItemCodes = {
    'registration': '1852',
  ...
  exports.invoiceItem = function (item) {
    ...
    if (type === 'classification' || type === 'reclassification') {
      ...
      const pricePerMinute = !short
      const itemUnit = pricePerMinute ? 'min' : 'kpl'
      const itemCount = pricePerMinute ? Math.ceil(item.duration / 60) : 1
      return {itemCode: code, itemUnit: itemUnit, itemCount: itemCount, pricePerMinute: pricePerMinute}
    }
    return {itemCode: exports.invoiceItemCodes[type], itemUnit: 'kpl', itemCount: 1, pricePerMinute: false}
  }

  exports.providingTypePrices = {
  ...
  exports.util.programTypeName = function(programType) {
    const p = exports.programType[programType]
  ...
  exports.util.isDefinedProgramType = function (i) { return i >= 1 && i <= 7 }
  exports.util.isTvSeriesName = function (p) { return p && p.programType === 2 }
  exports.util.isUnknown = function (p) { return p && p.programType === 0 }
  ...
  exports.reclassificationReason = {
    0: {emailText: 'Kuvin oma aloite', uiText: 'Kuvin oma aloite'},
  ...
  exports.kaviType = {
    0: {emailText: 'Kuvin esitystoiminta', uiText: 'Kuvin esitystoiminta'},
    1: {emailText: 'Maksullinen luokittelu', uiText: 'Maksullinen luokittelu'},
    2: {emailText: 'Muu', uiText: 'Muu'}
  }

  exports.isOikaisupyynto = function(val) { return parseInt(val) === 3 }
  ...
  exports.authorOrganizationIsKavi = function(c) { return c.authorOrganization === 1 }
  exports.authorOrganizationIsKuvaohjelmalautakunta = function(c) { return c.authorOrganization === 2 }
  ...
  exports.invoiceRowType = {
    ...
    classification: 'Kuvin luokittelu',
    reclassification: 'Kuvin uudelleenluokittelu'
  }
  ...
  exports.getCountryCode = function(country) {
    ...
    return _(exports.countries).mapValues(function(c) {
      return c.toLowerCase()
    }).invert().value()[country.toLowerCase()]
  }

  exports.util.toCountry = function(code) { return exports.countries[code] || '-' }
  exports.util.toCountryString = function(countries) { return countries.map(function(c) { return exports.countries[c] }).join(', ') }

  exports.warnings = {violence: 'Väkivalta', sex: 'Seksi', fear: 'Ahdistus', drugs: 'Päihteet'}

// Eventually classification criteria titles and descriptions should be retrieved from db
  exports.classificationCriteria = [
  ...
  exports.billingLanguages = {
    'FI': 'Suomi',
    'SV': 'Ruotsi',
    'EN': 'Englanti'
  }

  exports.billingLanguage = function(k) { return exports.billingLanguage[k] }
