...
describe('categorization-test', function() {
  ...
  it('can categorize as USER', function(done) {
    webdriver.client()
      ...
      .select2one('#search-page .categorization-form .select2-container.x-category-select', 'trai', 'Trailer')
      .click('#search-page .categorization-form button.save-category')
      .waitForText('#search-page .results .result .program-type', 'Trailer')
